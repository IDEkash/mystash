    ...
    */
    ...
    /*
        ...
        */
        ...
        TOCLIENT_HTMLVIEW_OP = 0x68,
        /*
            std::string id
            u8 op
            op 0: create/remove htmlview (followed by serialized HTMLViewOp struct)
            op 1: show/hide htmlview
            op 2: send to htmlview
            op 3: navigate htmlview
            op 4: inject javascript into htmlview
        */

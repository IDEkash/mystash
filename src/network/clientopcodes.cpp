...
const ToClientCommandHandler toClientCommandTable[TOCLIENT_NUM_MSG_TYPES] =
{
	...
	{ "TOCLIENT_MINIMAP_MODES",            TOCLIENT_STATE_CONNECTED, &Client::handleCommand_MinimapModes }, // 0x62,
		...
		{ "TOCLIENT_REGISTER_SHADER",         TOCLIENT_STATE_CONNECTED, &Client::handleCommand_RegisterShader }, // 0x69,
		{ "TOCLIENT_SET_SHADER_UNIFORM",      TOCLIENT_STATE_CONNECTED, &Client::handleCommand_SetShaderUniform }, // 0x6a,
	};

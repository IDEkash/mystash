...
int ObjectRef::l_set_physics_override(lua_State *L)
{
    ...
    getfloatfield(L, 2, "sprint_multiplier", phys.sprint_multiplier);
    getfloatfield(L, 2, "sprint_threshold", phys.sprint_threshold);
...
int ObjectRef::l_get_physics_override(lua_State *L)
{
    ...
    lua_pushnumber(L, phys.sprint_multiplier);
    lua_setfield(L, -2, "sprint_multiplier");
    lua_pushnumber(L, phys.sprint_threshold);
    lua_setfield(L, -2, "sprint_threshold");
    return 1;
}

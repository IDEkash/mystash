-- Creative Composition Interface (CCI) for Luanti modders
-- Author: Jules
...
local function run_unit_tests()
	minetest.log("action", "[CCI] Running unit test suite...")
	...
	minetest.log("action", "[CCI] All unit tests passed successfully!")
end

-- Run unit tests on mod load
run_unit_tests()
